...
import { HistoryIcon, ListIcon, ListVideoIcon, ThumbsUpIcon } from "lucide-react";
...
export const SubscriptionsSection = () => {
  ...
  const { data: subscriptions, isLoading } = trpc.subscriptions.getMany.useInfiniteQuery({ limit: DEFAULT_LIMIT },
    ...
    <SidebarGroup>
      ...
      <SidebarGroupContent>
        <SidebarMenu>
          ...
          {!isLoading && subscriptions?.pages.flatMap((page) => page.items).map((subscription) => (
